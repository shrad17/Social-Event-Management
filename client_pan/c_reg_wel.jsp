...
<div class="content"><div class="ic">More Website Templates @ TemplateMonster.com - July 08, 2013!</div>
	<div class="white wt2">
		<div class="container_12">
			...
			<div class="grid_4">
				<h3><font color="navy blue">Registration Successfully:</h3>
					
				<h6>
				<font color="green">Now You Can Login To Our Website...PLZ LOGOUT AND THEN LOGIN
				<br>
				...Get Desire Facilities Which You Require
				<br>NOTE your User name and password :<br><br>
				</font></h6>
				
				<address>
					Your UserName : <% out.println(request.getAttribute("EMAIL")); %> <br>
					Your Password : <% out.println(request.getAttribute("PASS")); %> <br>
				</address>
				</div>
