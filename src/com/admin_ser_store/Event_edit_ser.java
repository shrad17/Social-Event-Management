...
/**
 * Servlet implementation class Event_edit_ser
 */
@WebServlet("/Event_edit_ser")
public class Event_edit_ser extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			String sel_data = "select * from events_tb where id = '"+id+"'";
			Statement st = con.createStatement();
			ResultSet rs = st.executeQuery(sel_data);
			
			request.setAttribute("EVENT_DATA", rs);
			RequestDispatcher rd = request.getRequestDispatcher("/admin_pan/event_edit.jsp");
