...
/**
 * Servlet implementation class Agent_remove_ser
 */
@WebServlet("/Agent_remove_ser")
public class Agent_remove_ser extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Agent_remove_ser() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("id")!=null)
		{
			try
			{
				...
				RequestDispatcher rd = request.getRequestDispatcher("Agent_view_ser");
